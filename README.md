...
<p>
  <a href="https://www.linkedin.com/in/karan-mattoo-b87649301"><img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" /></a>
...
karan = {
    ...
    "achievements": ["Top 11% — Great Hiring Hackathon", "Yale Financial Markets Certified"],
}
```

> I build models that ship.

---

## Projects

| Project | Stack | Metric | Impact |
|---------|-------|--------|--------|
...
| Domain | Experience |
|--------|-----------|
| **Fraud Detection** | Supervised + unsupervised on 1M+ live transactions |
| **Credit Risk** | Scoring models, NPA prevention, RBI-aligned work |
| **LLM Systems** | RAG, LoRA fine-tuning, prompt engineering |
| **Time Series** | Stock forecasting, stationarity, EMH validation |

---

## Highlights

- **Great Hiring Hackathon** — Ranked 109/1,010 (Top 11%)
- **Yale University** — Financial Markets Certification (Coursera, 2024)
- **Intellect Design Arena** — Fraud detection on 1M+ live Oracle DB transactions
